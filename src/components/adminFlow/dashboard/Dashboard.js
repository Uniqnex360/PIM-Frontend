...
setCompletenessChartData({
  ...
  return (
    ...
    <div className="dashboard-container">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-icon"><StoreIcon /></div>
          <div className="stat-content">
  ...
  <div className="stat-card">
    <div className="stat-icon"><AccountTreeIcon /></div>
    <div className="stat-content">
      <h3>Level 1 Categories</h3>
      <p>{dashboardData?.category?.level1 ?? 0}</p>
    </div>
  </div>
  ...
  <div className="stat-card">
    ...
    <div className="stat-content">
      ...
      <p>{dashboardData?.category?.level2 ?? 0}</p>
    </div>
  </div>
  ...
  <div className="stat-card">
    <div className="stat-icon"><AccountTreeIcon /></div>
    <div className="stat-content">
      <h3>End Level Categories</h3>
      <p>{dashboardData?.category?.end_level ?? 0}</p>
    </div>
  </div>
</div>
